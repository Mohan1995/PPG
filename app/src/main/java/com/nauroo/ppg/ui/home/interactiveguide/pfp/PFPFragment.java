package com.nauroo.ppg.ui.home.interactiveguide.pfp;
 ...
 * Use the {@link PFPFragment#newInstance} factory method to
...
public class PFPFragment extends Fragment {
     ...
     * @return A new instance of fragment PFPFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PFPFragment newInstance(String param1, String param2) {
        PFPFragment fragment = new PFPFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_pf, container, false);
    ...
    private void intializeFirstButtonData() {
        ...
        String tittle = getString(R.string.pfp_button_1_tittle);
        changeTittle(tittle);
        ...
        interactiveGuideModel1.setHeader(getString(R.string.pfp_button_1_header_1));
        interactiveGuideModel1.setBody(getString(R.string.pfp_button_1_header_1_body));
        ...
        interactiveGuideModel12.setHeader(getString(R.string.pfp_button_1_header_2));
        interactiveGuideModel12.setBody(getString(R.string.pfp_button_1_header_2_body));
        ...
        switch (view.getId()) {
            ...
            case R.id.button2:
                if (previouslyClickedButton != button2) {
                    ...
                    String tittle = getString(R.string.pfp_button_2_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_2_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_2_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.pfp_button_2_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.pfp_button_2_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
            ...
            case R.id.button3:
                if (previouslyClickedButton != button3) {
                    ...
                    String tittle = getString(R.string.pfp_button_3_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_3_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_3_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.pfp_button_3_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.pfp_button_3_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
            ...
            case R.id.button4:
                ...
                if (previouslyClickedButton != button4) {
                    ...
                    String tittle = getString(R.string.pfp_button_4_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_4_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_4_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.pfp_button_4_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.pfp_button_4_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);

                    InteractiveGuideModel interactiveGuideModel13=new InteractiveGuideModel();
                    interactiveGuideModel13.setHeader(getString(R.string.pfp_button_4_header_3));
                    interactiveGuideModel13.setBody(getString(R.string.pfp_button_4_header_3_body));
            ...
            case R.id.button5:
                if (previouslyClickedButton != button5) {
                    ...
                    String tittle = getString(R.string.pfp_button_5_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_5_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_5_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.pfp_button_5_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.pfp_button_5_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);

                    InteractiveGuideModel interactiveGuideModel13=new InteractiveGuideModel();
                    interactiveGuideModel13.setHeader(getString(R.string.pfp_button_5_header_3));
                    interactiveGuideModel13.setBody(getString(R.string.pfp_button_5_header_3_body));
                    interactiveGuideModelList.add(interactiveGuideModel13);
            ...
            case R.id.button6:
                if (previouslyClickedButton != button6) {
                    ...
                    String tittle = getString(R.string.pfp_button_6_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_6_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_6_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.pfp_button_6_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.pfp_button_6_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
            ...
            case R.id.button7:
                ...
                if (previouslyClickedButton != button7) {
                    ...
                    String tittle = getString(R.string.pfp_button_7_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.pfp_button_7_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.pfp_button_7_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);
