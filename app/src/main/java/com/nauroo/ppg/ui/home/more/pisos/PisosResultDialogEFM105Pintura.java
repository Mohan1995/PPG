...
public class PisosResultDialogEFM105Pintura extends Dialog implements
    ...
    public PisosResultDialogEFM105Pintura(Activity a, double performanceTheoretical, double performancePractical, double paintVolume, int eph, double totalVolume, double litersPartA, double litersPartB, double litterOfMix, double aggregates) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PisosCalculatorResultEfm105PinturaLayoutBinding binding=PisosCalculatorResultEfm105PinturaLayoutBinding.inflate(LayoutInflater.from(getContext()));
