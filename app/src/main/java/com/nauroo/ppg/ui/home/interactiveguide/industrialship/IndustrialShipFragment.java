package com.nauroo.ppg.ui.home.interactiveguide.industrialship;
 ...
 * Use the {@link IndustrialShipFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IndustrialShipFragment extends Fragment {
     ...
     * @return A new instance of fragment IndustrialShipFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IndustrialShipFragment newInstance(String param1, String param2) {
        IndustrialShipFragment fragment = new IndustrialShipFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_industrial_ship, container, false);
    ...
    private void initializeFirstButtonData() {
        ...
        String tittle = getString(R.string.industrial_ship_button_1_tittle);
        changeTittle(tittle);
        ...
        interactiveGuideModel1.setHeader(getString(R.string.industrial_ship_button_1_header));
        interactiveGuideModel1.setBody(getString(R.string.industrial_ship_button_1_header_1_body));
        ...
        switch (view.getId()) {
            ...
            case R.id.button2:
                if (previouslyClickedButton != button2) {
                    ...
                    String tittle = getString(R.string.industrial_ship_button_2_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industrial_ship_button_2_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industrial_ship_button_2_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.industrial_ship_button_2_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.industrial_ship_button_2_header_2_body));
            ...
            case R.id.button3:
                ...
                if (previouslyClickedButton != button3) {
                    ...
                    String tittle = getString(R.string.industrial_ship_button_3_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industrial_ship_button_3_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industrial_ship_button_3_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.industrial_ship_button_3_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.industrial_ship_button_3_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
            ...
            case R.id.button4:
                if (previouslyClickedButton != button4) {
                    ...
                    String tittle = getString(R.string.industrial_ship_button_4_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industrial_ship_button_4_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industrial_ship_button_4_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.industrial_ship_button_4_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.industrial_ship_button_4_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
