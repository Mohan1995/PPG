package com.nauroo.ppg.ui.home.interactiveguide.gas_de_petroleo;
 ...
 * Use the {@link GasDePetrolFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GasDePetrolFragment extends Fragment {
     ...
     * @return A new instance of fragment GasDePetrolFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GasDePetrolFragment newInstance(String param1, String param2) {
        GasDePetrolFragment fragment = new GasDePetrolFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gas_de_petrol, container, false);
        ...
        switch (view.getId()) {
            case R.id.button1:
                if (previouslyClickedButton != button1) {
                    ...
                    String tittle = getString(R.string.gas_y_petroleo_1_tittle);
                    changeTittle(tittle);
                    ...
                    interactiveGuideModel1.setHeader(getString(R.string.gas_y_petroleo_1_tittle_1_head));
                    interactiveGuideModel1.setBody(getString(R.string.gas_y_petroleo_1_tittle_1_head_body));
                    ...
                    interactiveGuideModel12.setHeader(getString(R.string.gas_y_petroleo_1_tittle_2_head));
                    interactiveGuideModel12.setBody(getString(R.string.gas_y_petroleo_1_tittle_2_head_body));
            ...
            case R.id.button2:
                if (previouslyClickedButton != button2) {
                    ...
                    String tittle = getString(R.string.gas_y_petroleo_2_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.gas_y_petroleo_2_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.gas_y_petroleo_2_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.gas_y_petroleo_2_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.gas_y_petroleo_2_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
                    setUpRecyclerView(interactiveGuideModelList);
                }
                break;
            case R.id.button3:
                if (previouslyClickedButton != button3) {
                    ...
                    String tittle = getString(R.string.gas_y_petroleo_3_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.gas_y_petroleo_3_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.gas_y_petroleo_3_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.gas_y_petroleo_3_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.gas_y_petroleo_3_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);

                    InteractiveGuideModel interactiveGuideModel13 = new InteractiveGuideModel();
                    interactiveGuideModel13.setHeader(getString(R.string.gas_y_petroleo_3_header_3));
                    interactiveGuideModel13.setBody(getString(R.string.gas_y_petroleo_3_header_3_body));
            ...
            case R.id.button4:
                if (previouslyClickedButton != button4) {
                    ...
                    String tittle = getString(R.string.gas_y_petroleo_4_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.gas_y_petroleo_4_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.gas_y_petroleo_4_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);
            ...
            case R.id.button5:
                if (previouslyClickedButton != button5) {
                    ...
                    String tittle = getString(R.string.gas_y_petroleo_5_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList = new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1 = new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.gas_y_petroleo_5_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.gas_y_petroleo_5_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12 = new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.gas_y_petroleo_5_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.gas_y_petroleo_5_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);

                    InteractiveGuideModel interactiveGuideModel13 = new InteractiveGuideModel();
                    interactiveGuideModel13.setHeader(getString(R.string.gas_y_petroleo_5_header_3));
                    interactiveGuideModel13.setBody(getString(R.string.gas_y_petroleo_5_header_3_body));
                    interactiveGuideModelList.add(interactiveGuideModel13);
                    setUpRecyclerView(interactiveGuideModelList);
                }
                break;
