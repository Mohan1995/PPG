package com.nauroo.ppg.ui.home.interactiveguide.structures;
...
public class StructuresFragment extends Fragment {
     ...
     * @return A new instance of fragment StructuresFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static StructuresFragment newInstance(String param1, String param2) {
        StructuresFragment fragment = new StructuresFragment();
    ...
    private void intializeFirstButtonData() {
        ...
        String tittle = getString(R.string.strucutres_button_1_tittle);
        changeTittle(tittle);
        ...
        interactiveGuideModel1.setHeader(getString(R.string.strucutres_button_1_header_1));
        interactiveGuideModel1.setBody(getString(R.string.strucutres_button_1_header_1_body));
        ...
        interactiveGuideModel12.setHeader(getString(R.string.strucutres_button_1_header_2));
        interactiveGuideModel12.setBody(getString(R.string.strucutres_button_1_header_2_body));
        ...
        switch (view.getId()) {
            ...
            case R.id.button2:
                ...
                if (previouslyClickedButton != button2) {
                    ...
                    String tittle = getString(R.string.strucutres_button_2_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.strucutres_button_2_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.strucutres_button_2_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);
            ...
            case R.id.button3:
                ...
                if (previouslyClickedButton != button3) {
                    ...
                    String tittle = getString(R.string.strucutres_button_3_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.strucutres_button_3_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.strucutres_button_3_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.strucutres_button_3_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.strucutres_button_3_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
