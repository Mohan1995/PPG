package com.nauroo.ppg.ui.home.interactiveguide.industria_ferroviaria;
 ...
 * Use the {@link IndustriaFerroviariaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IndustriaFerroviariaFragment extends Fragment {
    ...
    public IndustriaFerroviariaFragment() {
     ...
     * @return A new instance of fragment IndustriaFerroviariaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IndustriaFerroviariaFragment newInstance(String param1, String param2) {
        IndustriaFerroviariaFragment fragment = new IndustriaFerroviariaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_second_interactive_guide, container, false);
        ButterKnife.bind(this, view);
        showDialoge();
        intializeFirstButton();
        return view;
    }

    private void intializeFirstButton() {
        changeButtonAsActive(button1);
        previouslyClickedButton = button1;
        String tittle = getString(R.string.industria_farroviaria_1_tittle);
        changeTittle(tittle);
        ...
        interactiveGuideModel1.setHeader(getString(R.string.industria_farroviaria_1_header_1));
        interactiveGuideModel1.setBody(getString(R.string.industria_farroviaria_1_header_1_body));
        ...
        interactiveGuideModel12.setHeader(getString(R.string.industria_farroviaria_1_header_2));
        interactiveGuideModel12.setBody(getString(R.string.industria_farroviaria_1_header_2_body));
        ...
        switch (view.getId()) {
            ...
            case R.id.button2:
                if (previouslyClickedButton != button2) {
                    ...
                    String tittle = getString(R.string.industria_farroviaria_2_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industria_farroviaria_2_header));
                    interactiveGuideModel1.setBody(getString(R.string.industria_farroviaria_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);
            ...
            case R.id.button3:
                if (previouslyClickedButton != button3) {
                    ...
                    String tittle = getString(R.string.industria_farroviaria_3_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industria_farroviaria_3_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industria_farroviaria_3_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);
            ...
            case R.id.button4:
                if (previouslyClickedButton != button4) {
                    ...
                    String tittle = getString(R.string.industria_farroviaria_4_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industria_farroviaria_4_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industria_farroviaria_4_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.industria_farroviaria_4_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.industria_farroviaria_4_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
                    setUpRecyclerView(interactiveGuideModelList);
                }
                break;
            case R.id.button5:
                if (previouslyClickedButton != button5) {
                    ...
                    String tittle = getString(R.string.industria_farroviaria_5_tittle);
                    changeTittle(tittle);
                    List<InteractiveGuideModel> interactiveGuideModelList=new ArrayList<>();
                    InteractiveGuideModel interactiveGuideModel1=new InteractiveGuideModel();
                    interactiveGuideModel1.setHeader(getString(R.string.industria_farroviaria_5_header_1));
                    interactiveGuideModel1.setBody(getString(R.string.industria_farroviaria_5_header_1_body));
                    interactiveGuideModelList.add(interactiveGuideModel1);

                    InteractiveGuideModel interactiveGuideModel12=new InteractiveGuideModel();
                    interactiveGuideModel12.setHeader(getString(R.string.industria_farroviaria_5_header_2));
                    interactiveGuideModel12.setBody(getString(R.string.industria_farroviaria_5_header_2_body));
                    interactiveGuideModelList.add(interactiveGuideModel12);
                    setUpRecyclerView(interactiveGuideModelList);
                }
                break;
